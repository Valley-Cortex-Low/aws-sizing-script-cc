...
echo "  --------------------------------------"
echo "     *Note: $total_iam_users AWS IAM users were found. If 'SaaS users'"
echo "      refers to external identity platforms (e.g. M365/Google), those"
echo "      cannot be queried via the AWS CLI and must be counted separately."
echo ""
